  ...
  return (
    ...
    <div className="register_parent_container">
        ...
        <form action="" className="registrationform"  >
          ...
          <div>
          <input type="date" name="DOB" placeholder="Enter your dob" value={values.DOB}   /></div>
          
          <div>
            <div>
              <label htmlFor="">Start Date</label>
              <div>
              <input type="date" name="StartDate" value={values.StartDate}/></div>
            </div>
            <div>
              <label htmlFor="">End Date</label>
              <input type="date" name="EndDate" value={values.LastName}  />
            </div>
          </div>
